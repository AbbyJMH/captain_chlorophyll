...
ciEnvelope(forecast_dates,rep(0,ncol(V.pred.rel.in)),V.pred.rel.in[1,],col=N.cols[4])
ciEnvelope(forecast_dates,V.pred.rel.in[1,],V.pred.rel.in[2,],col=N.cols[3])
ciEnvelope(forecast_dates,V.pred.rel.in[2,],V.pred.rel.in[3,],col=N.cols[2])
ciEnvelope(forecast_dates,V.pred.rel.in[3,],V.pred.rel.in[4,],col=N.cols[1])
legend("topleft",legend=c("Process","Driver","Parameter","InitCond"),col=N.cols,lty=1,lwd=5)
```